...
orchard_path = 'mountdata/' + country + 'orchardsSR-unnormalized'
forest_path = 'mountdata/' + country + 'forestsSR-unnormalized'
...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs-1:
        ...
        print(misclf)
        mistakes_s2 = misclf
        with open(country+"_mistakes_s2.json", 'w') as f:
...
plt.legend()
plt.show()
plt.savefig(country+'-s2-loss.png')
...
plt.legend()
plt.show()
plt.savefig(country+'-s2-acc.png')
...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs-1:
        ...
        print(misclf)
        mistakes = misclf
        with open(country+"mistakes_SR.json", 'w') as f:
...
plt.legend()
plt.show()
plt.savefig(country+'-SR-loss.png')
...
plt.legend()
plt.show()
plt.savefig(country+'-SR-acc.png')

orchard_path = 'mountdata/'+country+'orchards2-50m'
forest_path = 'mountdata/'+country+'forests2-50m'
...
for epoch in range(num_epochs):
    ...
    if epoch == num_epochs-1:
        ...
        with open(country+"_mistakes_bicub.json", 'w') as f:
...
plt.legend()
plt.show()
plt.savefig(country+'-bicub-loss.png')
...
plt.legend()
plt.show()
plt.savefig(country+'-bicub-acc.png')
